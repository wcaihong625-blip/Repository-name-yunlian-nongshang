		...
		<view v-if="!isPhone" v-show="pickerVisible" ref="datePicker" class="uni-date-picker__container">
			<view v-if="!isRange" class="uni-date-single--x" :style="pickerPositionStyle">
				...
				<view v-if="hasTime" class="uni-date-changed popup-x-header">
					...
					<time-picker type="time" :model-value="pickerTime" @update:model-value="pickerTime = $event" :border="false" :disabled="!inputDate"
			...
			<view v-else class="uni-date-range--x" :style="pickerPositionStyle">
				...
				<view v-if="hasTime" class="popup-x-header uni-date-changed">
					<view class="popup-x-header--datetime">
						...
						<time-picker type="time" :model-value="tempRange.startTime" @update:model-value="tempRange.startTime = $event" :start="timepickerStartTime" :border="false"
					...
					<view class="popup-x-header--datetime">
						...
						<time-picker type="time" :model-value="tempRange.endTime" @update:model-value="tempRange.endTime = $event" :end="timepickerEndTime" :border="false"
