<template>
  <view>
    <!-- 一、月结预览：仅当月，月份必选 -->
    <view class="uni-header section-block">
    ...
    <view class="uni-header section-block list-filter-block">
    ...
    <view class="uni-container preview-box" v-if="previewSettleMonth">
...
.preview-box { margin-bottom: 16px; padding: 12px 16px; background: #fafafa; border: 1px solid #eee; border-radius: 6px; }
