...
module.exports = function getWechatConfig() {
  ...
  throw new Error(
    '微信小程序配置缺失：请先创建 uniCloud-aliyun/cloudfunctions/common/uni-config-center/wechat-login/config.json，并填写 weixin.appId、weixin.appSecret；或者在云函数环境变量中配置 WX_APP_ID / WX_APP_SECRET（兼容旧名称 WECHAT_APPID / WECHAT_SECRET）。'
  );
};
