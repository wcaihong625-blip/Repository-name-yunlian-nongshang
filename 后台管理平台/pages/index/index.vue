...
<style scoped>
	...
	.hero-card { @include admin-card; padding: 20px; margin-bottom: 16px; display: flex; justify-content: space-between; align-items: center; gap: 12px; }
	.hero-title { display: block; font-size: 22px; font-weight: 600; color: #0f172a; }
	.hero-subtitle { display: block; margin-top: 6px; font-size: 13px; color: #9aa8bc; }
	...
	.todo-card { @include admin-card; padding: 12px; cursor: pointer; min-height: 102px; }
