  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="amount" label="支付金额" required>
        <uni-easyinput v-model="formData.amount" type="number" placeholder="支付金额"></uni-easyinput>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("order_no,shop_id,shop_name,user_id,user_name,plan_type,amount,payment_method,payment_channel,transaction_id,status,pay_date,expire_date,remark,updated_date").get().then((res) => {
