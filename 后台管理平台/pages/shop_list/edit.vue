  ...
  <view class="page-container">
    ...
    <view class="page-header">
      <view class="header-title">
        ...
        <text class="title-text">编辑店铺信息</text>
      </view>
      <view class="header-subtitle">修改店铺的详细信息</view>
    </view>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("shopName,category,region,address,contactName,phone,image,plan,user_id,owner,status,updated_date,approved_date,rejected_reason").get().then((res) => {
